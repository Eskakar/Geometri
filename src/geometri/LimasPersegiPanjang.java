...
public class LimasPersegiPanjang extends PersegiPanjang {
    ...
    public void hitungLuasPermukaan() {
        double tinggiSisiMiring1 = Math.sqrt(Math.pow(this.tinggi, 2) + Math.pow(this.panjang / 2, 2));
        double tinggiSisiMiring2 = Math.sqrt(Math.pow(this.tinggi, 2) + Math.pow(this.lebar / 2, 2));
